...
If you completed the setup in [Your First Session](first-session.qmd), the LINCS skills are already installed in `claude_workshop/.claude/skills/` and Claude Code will pick them up automatically when you launch it from `claude_workshop`. Try:
